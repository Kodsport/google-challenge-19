...
In the attachments section, you are able to download an English dictionary (\texttt{dict.txt}) containing a sorted list of words, one per line,
...
This limit includes files submitted along with the program, along with the lengths of the file names.

It may be useful to know that it is possible to submit files alongside your program on Kattis.
Such files can then be read from the working directory where your solution is run.

If you wish to submit binary files, we recommend submitting using the tool \href{https://github.com/Kattis/kattis-cli}{kattis-cli}.
